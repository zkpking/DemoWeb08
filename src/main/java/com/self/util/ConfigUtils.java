...
public class ConfigUtils {
	...
	public void initTableField() {
		...
		try {
			...
			String packageName = "com.self.entity";
			...
			String sql = "select TABLE_NAME,group_concat(COLUMN_NAME) COLUMN_NAME from information_schema.columns where table_name in ("
					+ tabs + ") and table_schema = '" + db + "'  GROUP BY TABLE_NAME";
