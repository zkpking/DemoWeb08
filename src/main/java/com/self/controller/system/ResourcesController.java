...
import com.self.entity.ButtomFormMap;
import com.self.entity.Params;
import com.self.entity.ResFormMap;
import com.self.entity.ResUserFormMap;
import com.self.entity.RoleFormMap;
import com.self.entity.RoleResFormMap;
import com.self.entity.UserGroupsFormMap;
...
public class ResourcesController extends BaseController {
	...
	public String addUserRes() throws Exception {
		...
		if (null != u && !Common.isEmpty(u.toString())) {
			...
			List<UserGroupsFormMap> gs = resourcesMapper.findByAttribute("roleId", g.toString(),
