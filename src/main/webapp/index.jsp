		...
		<header class="bg-dark dk header navbar navbar-fixed-top-xs">
			<div class="navbar-header aside-md" >
				...
				<a href="index.shtml#" class="navbar-brand" data-toggle="fullscreen">
					<img src="${ctx}/notebook/notebook_files/logo.png" class="m-r-sm">MENU
				</a>
			...
			<ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
				<li class="hidden-xs">
					<a href="index.html#" class="dropdown-toggle dk" data-toggle="dropdown"> 
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu animated fadeInRight">
						...
						<li><a href="#"><span class="count badge bg-danger pull-right" style="display: inline;"></span>消息</a></li>
						<li class="divider"></li>
