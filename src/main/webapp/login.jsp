...
<body style="background-image: url('${pageContext.servletContext.contextPath }/admin_files/4.jpg');margin-top:0px;background-repeat: round;">
		...
		<form id="loginform" name="loginform" class="form-vertical"
			...
			<div class="control-group normal_text">
				<table style="width: 100%">
					<tr>
						<td align="left">
							<img src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png" alt="Logo"/>
						</td>
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly" style="background: #28b779">
							<img src="${pageContext.servletContext.contextPath }/admin_files/account_1.png" alt="请输入账号.."/>
						</span>
						<input type="text" placeholder="username" name="username" style="height: 32px; margin-bottom: 0px;"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
					<div class="main_input_box">
						...
						<input type="password" placeholder="password" name="password" style="height: 32px; margin-bottom: 0px;"/>
					</div>
				</div>
			</div>
