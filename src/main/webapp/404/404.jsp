		...
		<DIV id=page>
			...
			<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
				<TBODY>
					<TR>
						<TD><IMG
							src="${pageContext.servletContext.contextPath }/404/1.gif"
							width="17" height="18"></TD>
						<TD width="100%"
							background="${pageContext.servletContext.contextPath }/404/3.gif"></TD>
						<TD><IMG
							src="${pageContext.servletContext.contextPath }/404/2.gif"
							width="17" height="18"></TD>
					</TR>
				</TBODY>
			</TABLE>
			<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
				<TBODY>
					<TR>
								...
								<TBODY>
									<TR>
										<TD align=left width="80%" height=30>
											&nbsp;您现在位于：&nbsp;http://<script Language="JavaScript"></script>
						...
						<TD width=7
							background="${pageContext.servletContext.contextPath }/404/right.gif"></TD>
					</TR>
				</TBODY>
			</TABLE>
			<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
										...
										<TD class=bg_1 align=middle height=300>
											<TABLE cellSpacing=0 cellPadding=0 width=590 border=0>
												<TBODY>
													<TR>
														<TD align=right><IMG
															src="${pageContext.servletContext.contextPath }/404/center_error.gif"
															width="450" height="32" border=0></TD>
													</TR>
													<TR>
																...
																<TBODY>
																	...
																	<TR>
																		...
																		<TD class=htd align=middle width=479 bgColor=#f7f7f7
																			height=228><span
																			style="color: red; font-weight: 900; font-size: 40px;">404</span><br>
																		<br>
																			<P>
																				<FONT class=red size="5"><b>您的访问的页面可能被删除或不存在。</b></FONT><BR>
																				<BR>
						...
						<TD class=bg align=middle width=*>
							<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
								<TBODY>
									<TR>
										<TD><IMG
											src="${pageContext.servletContext.contextPath }/404/4.gif"
											width="17" height="18"></TD>
										<TD width="100%"
											background="${pageContext.servletContext.contextPath }/404/6.gif"></TD>
										<TD><IMG
											src="${pageContext.servletContext.contextPath }/404/5.gif"
											width="17" height="18"></TD>
									</TR>
								</TBODY>
							</TABLE>
